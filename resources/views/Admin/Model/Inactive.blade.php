    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Inactive Model List </h4>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a href="#" class="dropdown-item active-item" data-id="{{ $row->id }}" data-action="{{ route('model.active',[$row]) }}"><i class="mdi mdi-reload font-size-16 text-danger me-1"></i> Active</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
