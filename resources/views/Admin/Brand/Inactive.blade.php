                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a href="#" class="dropdown-item active-item" data-id="{{ $row->id }}" data-action="{{ route('brand.active',[$row]) }}"><i class="mdi mdi-reload font-size-16 text-danger me-1"></i> Active</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
