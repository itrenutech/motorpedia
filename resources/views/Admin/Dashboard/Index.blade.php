...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-4">
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <h5 class="font-size-15 text-truncate">Spoc Name</h5>
                            <p class="text-muted mb-0 text-truncate">Designation</p>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Monthly Received</h4>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mt-4">
                                <a href="#" class="btn btn-primary waves-effect waves-light btn-sm">View All <i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted fw-medium">Total Received</p>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p class="text-muted fw-medium">Tax Payable</p>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex flex-wrap">
                        <h4 class="card-title mb-4">Transaction Pattern</h4>
                        <div class="ms-auto">
                    ...
                    <div class="table-responsive mt-4">
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p class="mb-0">Haworth Solutions</p>
                                    </td>
                                    <td>
